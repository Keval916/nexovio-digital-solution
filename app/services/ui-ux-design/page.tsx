  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 overflow-hidden border-b border-border-subtle/80">
        ...
        <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-brand-cyan/10 rounded-full blur-[140px] pointer-events-none -z-10" />
        <div className="absolute top-1/3 left-10 w-[500px] h-[500px] bg-brand-electric/10 rounded-full blur-[130px] pointer-events-none -z-10" />
