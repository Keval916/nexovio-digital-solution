...
export const metadata = generatePageMetadata({
  title: "SEO & Digital Marketing Services | Organic Traffic Growth",
  description:
    "Comprehensive SEO and digital marketing to boost your online visibility. We focus on technical SEO, content strategy and conversion optimization to drive qualified traffic and leads.",
  keywords: [
    "SEO services",
